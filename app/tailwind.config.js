  ...
  theme: {
    extend: {
      colors: {
        ...
        'poi-bg': 'rgb(var(--poi-bg) / <alpha-value>)',
        hospital: 'rgb(var(--hospital) / <alpha-value>)',
        clinic: 'rgb(var(--clinic) / <alpha-value>)',
        pharmacie: 'rgb(var(--pharmacie) / <alpha-value>)',
        aed: 'rgb(var(--aed) / <alpha-value>)',
        police: 'rgb(var(--police) / <alpha-value>)',
        'fire-station': 'rgb(var(--fire-station) / <alpha-value>)',
        shelter: 'rgb(var(--shelter) / <alpha-value>)',
        'water-source': 'rgb(var(--water-source) / <alpha-value>)',
        'gas-station': 'rgb(var(--gas-station) / <alpha-value>)',
      },
    },
  },
  plugins: [],
